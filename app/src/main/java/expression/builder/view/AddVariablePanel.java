...
public final class AddVariablePanel extends JPanel {
    ...
    public record Result(String name, String comment, String variableType, String expression) {
    }
    ...
    public AddVariablePanel() {
        ...
        typeComboBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                boolean constant = typeComboBox.getSelectedItem().equals("Constant");
                boolean updatable = typeComboBox.getSelectedItem().equals("Updatable Variable");
                if (!updatable){
                    if (listener !=null) {
                ...
                importField.setVisible(updatable);
                importLabel.setVisible(updatable);
                importBtn.setVisible(updatable);
                revalidate();
                if (listener!=null) {
                    listener.hideScript(!updatable && !constant);
                    if (constant) {
                        listener.constantBorder();
                    } else if (updatable) {
                        listener.updatableBorder();
                    } else{
                        listener.expressionBorder();
                    }
                }
    ...
    public Result getResult() {
        return new Result(nameField.getText(), commentField.getText(), (String) typeComboBox.getSelectedItem(), importField.getText());
    }
